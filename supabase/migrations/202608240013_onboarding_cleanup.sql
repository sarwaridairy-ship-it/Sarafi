-- Remove an unused local from the live onboarding function; behavior is unchanged.
...
begin
  ...
  insert into public.cashboxes (organization_id, branch_id, name) values (organization_row.id, branch_id_value, coalesce(command->>'cashbox_name', 'Main Counter'));
