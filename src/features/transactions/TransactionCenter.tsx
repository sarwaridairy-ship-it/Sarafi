...
const families: Family[] = [
  {
    id: "fx",
    label: { en: "Currency Exchange", "fa-AF": "تبادله اسعار", "ps-AF": "د اسعارو تبادله" },
    intro: { en: "Buy, sell, or exchange currency.", "fa-AF": "خرید، فروش یا تبدیل اسعار.", "ps-AF": "اسعار وپېرئ، وپلورئ یا بدل یې کړئ." },
    icon: "trade",
    actions: [
      { label: { en: "Buy currency", "fa-AF": "خرید ارز", "ps-AF": "اسعار پېرل" }, route: "/fx/buy", capability: "financial.post.fx" },
      { label: { en: "Sell currency", "fa-AF": "فروش ارز", "ps-AF": "اسعار پلورل" }, route: "/fx/sell", capability: "financial.post.fx" },
      { label: { en: "Exchange currencies", "fa-AF": "تبدیل دو ارز", "ps-AF": "دوه اسعار بدلول" }, route: "/fx/exchange", capability: "financial.post.fx" },
    ],
  },
  {
    id: "money-in",
    label: { en: "Money In", "fa-AF": "ورود پول", "ps-AF": "د پیسو داخل" },
  ...
  {
    id: "money-out",
    label: { en: "Money Out", "fa-AF": "خروج پول", "ps-AF": "د پیسو وتل" },
