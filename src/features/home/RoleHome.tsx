...
function OwnerHome(props: Omit<RoleHomeProps, "role">) {
  ...
  const summaries: Summary[] = [
    { label: local(language, "Net financial position", "وضعیت خالص مالی", "خالص مالي حالت"), value: `${money(dashboard?.net_position_base)} AFN`, note: local(language, "Money, receivables, payables and Hawala", "پول، طلب‌ها، قرض‌ها و حواله", "پیسې، اخیستنې، ورکړې او حواله"), icon: "wallet", private: true },
